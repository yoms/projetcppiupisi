...
# Generated by qmake (2.01a) (Qt 4.5.2) on: sam. mars 13 18:33:00 2010
# Project:  Projet.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Projet1.0.0/ && $(COPY_FILE) --parents plateau.h element.h agent.h feu.h mainwindow.h .tmp/Projet1.0.0/ && $(COPY_FILE) --parents main.cpp plateau.cpp element.cpp agent.cpp feu.cpp mainwindow.cpp .tmp/Projet1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Projet1.0.0/ && (cd `dirname .tmp/Projet1.0.0` && $(TAR) Projet1.0.0.tar Projet1.0.0 && $(COMPRESS) Projet1.0.0.tar) && $(MOVE) `dirname .tmp/Projet1.0.0`/Projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Projet1.0.0
