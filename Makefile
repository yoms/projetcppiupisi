...
# Generated by qmake (2.01a) (Qt 4.5.2) on: sam. mars 20 20:28:12 2010
# Project:  Projet.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		drone.cpp \
		victime.cpp \
		pompier.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		plateau.o \
		element.o \
		agent.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Projet1.0.0/ && $(COPY_FILE) --parents plateau.h element.h agent.h feu.h mainwindow.h robot.h secours.h capteur.h drone.h pda.h victime.h pompier.h .tmp/Projet1.0.0/ && $(COPY_FILE) --parents main.cpp plateau.cpp element.cpp agent.cpp feu.cpp mainwindow.cpp robot.cpp capteur.cpp drone.cpp victime.cpp pompier.cpp .tmp/Projet1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Projet1.0.0/ && (cd `dirname .tmp/Projet1.0.0` && $(TAR) Projet1.0.0.tar Projet1.0.0 && $(COMPRESS) Projet1.0.0.tar) && $(MOVE) `dirname .tmp/Projet1.0.0`/Projet1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Projet1.0.0
